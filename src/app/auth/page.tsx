...
export default function AuthPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      localStorage.setItem("cvhub_user", JSON.stringify({
        name: form.name || "User",
        email: form.email,
        loggedIn: true,
      }));
      toast({
        ...
        description: isLogin
          ...
          : "Your account has been created. Welcome to CVHub!",
      });
      navigate("/dashboard");
    }, 1000);
  };
      ...
      <div className="hidden lg:flex w-1/2 bg-primary items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-primary-foreground space-y-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold tracking-tight">CVHub</span>
          </div>
          <h2 className="text-4xl font-bold leading-tight">
            Build resumes that get you hired
          </h2>
          <p className="text-lg opacity-80 leading-relaxed">
            Create ATS-friendly, professional resumes in minutes. Join thousands of
            job seekers who landed their dream roles with CVHub.
          </p>
          <div className="flex flex-col gap-3 pt-4">
            {["ATS-optimized templates", "Real-time live preview", "One-click PDF download"].map((f) => (
